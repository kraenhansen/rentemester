...
export const expenseSpecs: CommandSpec[] = [
  {
    ...
    inputNotes: [
      ...
      "  non_deductible = bilag med moms hos en IKKE-momsregistreret virksomhed (§ 37): hele bilaget bogføres brutto på udgiftskontoen, ingen 4000 Købsmoms-linje, momsen indgår i kostprisen. Afvises for momsregistrerede selskaber — brug 'standard' der.",
